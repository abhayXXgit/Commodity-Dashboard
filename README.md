# TransformerProcure Intelligence

**Connects copper and aluminium prices to the rupee value at risk across live transformer
projects.**
...
> **The prices shipped with this repository are simulated**, generated by a seeded model and
> labelled `DEMO_DATA` on every screen. The analytics are real; the numbers are not. Connect
> a licensed feed or import official producer circulars before using any figure commercially.
> See [the data-honesty rules](#the-data-honesty-rules) for how the system keeps that
> distinction visible rather than convenient.
...
The commodity price data is *not* covered by this licence. LME data is licensed
separately and producer circulars remain the property of their publishers — connect
them under whatever terms your organisation holds.
